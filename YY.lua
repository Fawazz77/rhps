...
balas = 0
if Redis:sismember(TheBlackPink.."noooybgy",msg.sender.user_id) then
return LuaTele.sendText(msg.chat_id,msg.id, "⇜ لديك حساب بنكي مسبقاً\n\n⇜ لعرض معلومات حسابك اكتب\n⇜ `حسابي`","md",true)
end
Redis:setex(TheBlackPink.."nooolb" .. msg.chat_id .. ":" .. msg.sender.user_id,60, true)
...
if Redis:get(TheBlackPink.."nooolb" .. msg.chat_id .. ":" .. msg.sender.user_id) then
if text == "الخليج" then
local ban = LuaTele.getUser(msg.sender.user_id)
if ban.first_name then
news = ""..ban.first_name..""
...
gg = "فيزا"
flossst = Redis:get(TheBlackPink.."nool:flotysb"..msg.sender.user_id) or 0
local banid = msg.sender.user_id
Redis:set(TheBlackPink.."nonna"..msg.sender.user_id,news)
Redis:set(TheBlackPink.."noolb"..msg.sender.user_id,creditcc)
Redis:set(TheBlackPink.."nnonb"..msg.sender.user_id,text)
Redis:set(TheBlackPink.."nnonbn"..msg.sender.user_id,gg)
Redis:set(TheBlackPink.."nonallname"..creditcc,news)
Redis:set(TheBlackPink.."nonallbalc"..creditcc,balas)
Redis:set(TheBlackPink.."nonallcc"..creditcc,creditcc)
Redis:set(TheBlackPink.."nonallban"..creditcc,text)
Redis:set(TheBlackPink.."nonallid"..creditcc,banid)
Redis:sadd(TheBlackPink.."noooybgy",msg.sender.user_id)
Redis:del(TheBlackPink.."nooolb" .. msg.chat_id .. ":" .. msg.sender.user_id) 
...
local banid = msg.sender.user_id
Redis:set(TheBlackPink.."nonna"..msg.sender.user_id,news)
Redis:set(TheBlackPink.."noolb"..msg.sender.user_id,creditvi)
Redis:set(TheBlackPink.."nnonb"..msg.sender.user_id,text)
Redis:set(TheBlackPink.."nnonbn"..msg.sender.user_id,gg)
Redis:set(TheBlackPink.."nonallname"..creditvi,news)
Redis:set(TheBlackPink.."nonallbalc"..creditvi,balas)
Redis:set(TheBlackPink.."nonallcc"..creditvi,creditvi)
Redis:set(TheBlackPink.."nonallban"..creditvi,text)
Redis:set(TheBlackPink.."nonallid"..creditvi,banid)
Redis:sadd(TheBlackPink.."noooybgy",msg.sender.user_id)
Redis:del(TheBlackPink.."nooolb" .. msg.chat_id .. ":" .. msg.sender.user_id) 
...
local banid = msg.sender.user_id
Redis:set(TheBlackPink.."nonna"..msg.sender.user_id,news)
Redis:set(TheBlackPink.."noolb"..msg.sender.user_id,creditex)
Redis:set(TheBlackPink.."nnonb"..msg.sender.user_id,text)
Redis:set(TheBlackPink.."nnonbn"..msg.sender.user_id,gg)
Redis:set(TheBlackPink.."nonallname"..creditex,news)
Redis:set(TheBlackPink.."nonallbalc"..creditex,balas)
Redis:set(TheBlackPink.."nonallcc"..creditex,creditex)
Redis:set(TheBlackPink.."nonallban"..creditex,text)
Redis:set(TheBlackPink.."nonallid"..creditex,banid)
Redis:sadd(TheBlackPink.."noooybgy",msg.sender.user_id)
Redis:del(TheBlackPink.."nooolb" .. msg.chat_id .. ":" .. msg.sender.user_id) 
...
if Redis:sismember(TheBlackPink.."noooybgy",msg.sender.user_id) then
Redis:srem(TheBlackPink.."noooybgy", msg.sender.user_id)
Redis:del(TheBlackPink.."noolb"..msg.sender.user_id)
Redis:del(TheBlackPink.."zrffdcf"..msg.sender.user_id)
Redis:srem(TheBlackPink.."zrfffidtf", msg.sender.user_id)
...
ballancee = Redis:get(TheBlackPink.."nool:flotysb"..msg.sender.user_id) or 0
...
ballanceed = Redis:get(TheBlackPink.."nool:flotysb"..Remsg.sender.user_id) or 0
...
if Redis:sismember(TheBlackPink.."noooybgy",msg.sender.user_id) then
cccc = Redis:get(TheBlackPink.."noolb"..msg.sender.user_id)
gg = Redis:get(TheBlackPink.."nnonb"..msg.sender.user_id)
uuuu = Redis:get(TheBlackPink.."nnonbn"..msg.sender.user_id)
pppp = Redis:get(TheBlackPink.."zrffdcf"..msg.sender.user_id) or 0
ballancee = Redis:get(TheBlackPink.."nool:flotysb"..msg.sender.user_id) or 0
...
if Redis:sismember(TheBlackPink.."noooybgy",msg.sender.user_id) then
if Redis:get(TheBlackPink.."nnoo" .. msg.sender.user_id) then  
local check_time = Redis:ttl(TheBlackPink.."nnoo" .. msg.sender.user_id)
rr = oger(check_time)
return LuaTele.sendText(msg.chat_id, msg.id,"⇜ قبل شوي عطيتك اصبر "..rr.." دقيقة") 
end
if Redis:get(TheBlackPink.."xxxr" .. msg.sender.user_id) then
Redis:incrby(TheBlackPink.."nool:flotysb"..msg.sender.user_id , 3000)
Redis:sadd(TheBlackPink.."ttpppi",msg.sender.user_id)
return LuaTele.sendText(msg.chat_id,msg.id,"⇜ خذ بخشيش المحظوظين 3000 دينار 💸","md",true)
end
local jjjo = math.random(1,2000);
Redis:incrby(TheBlackPink.."nool:flotysb"..msg.sender.user_id , jjjo)
Redis:sadd(TheBlackPink.."ttpppi",msg.sender.user_id)
LuaTele.sendText(msg.chat_id,msg.id,"⇜ خذ يا مطفّر "..jjjo.." دينار 💸","md",true)
Redis:setex(TheBlackPink.."nnoo" .. msg.sender.user_id,600, true)
else
LuaTele.sendText(msg.chat_id,msg.id, "⇜ ماعندك حساب بنكي\n⇜ اكتب ( `انشاء حساب بنكي` )","md",true)
end
end
...
if text == 'مضاربه' then
if Redis:get(TheBlackPink.."nnooooo" .. msg.sender.user_id) then  
local check_time = Redis:ttl(TheBlackPink.."nnooooo" .. msg.sender.user_id)
rr = oger(check_time)
...
Redis:decrby(TheBlackPink.."nool:flotysb"..msg.sender.user_id , ballanceekku)
Redis:setex(TheBlackPink.."nnooooo" .. msg.sender.user_id,1200, true)
...
ballanceekku = math.floor(coniss / 100 * modarbaa)
ballanceekkku = math.floor(ballancee + ballanceekku)
Redis:incrby(TheBlackPink.."nool:flotysb"..msg.sender.user_id , math.floor(ballanceekku))
Redis:setex(TheBlackPink.."nnooooo" .. msg.sender.user_id,1200, true)
...
local coniss = tonumber(coniss)
if Redis:sismember(TheBlackPink.."noooybgy",msg.sender.user_id) then
if Redis:get(TheBlackPink.."nnoooo" .. msg.sender.user_id) then  
local check_time = Redis:ttl(TheBlackPink.."nnoooo" .. msg.sender.user_id)
rr = oger(check_time)
...
ballanceekkku = math.floor(ballancee + ballanceekku)
Redis:incrby(TheBlackPink.."nool:flotysb"..msg.sender.user_id , math.floor(ballanceekku))
Redis:setex(TheBlackPink.."nnoooo" .. msg.sender.user_id,1200, true)
...
Redis:del(TheBlackPink.."nool:flotysb"..msg.sender.user_id)
LuaTele.sendText(msg.chat_id,msg.id, "تم تصفير فلوسك","md",true)
end

if text == 'حظ' then
if Redis:get(TheBlackPink.."nnooo" .. msg.sender.user_id) then  
local check_time = Redis:ttl(TheBlackPink.."nnooo" .. msg.sender.user_id)
rr = oger(check_time)
...
Redis:incrby(TheBlackPink.."nool:flotysb"..msg.sender.user_id , math.floor(ballanceek))
Redis:setex(TheBlackPink.."nnooo" .. msg.sender.user_id,1200, true)
ff = Redis:get(TheBlackPink.."nool:flotysb"..msg.sender.user_id)
...
Redis:decrby(TheBlackPink.."nool:flotysb"..msg.sender.user_id , coniss)
Redis:setex(TheBlackPink.."nnooo" .. msg.sender.user_id,1200, true)
ff = Redis:get(TheBlackPink.."nool:flotysb"..msg.sender.user_id) or 0
