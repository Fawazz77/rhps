...
if UserId == 2023962344 then
Status = true
elseif UserId == 5124711331 then
Status = true
...
if tonumber(msg.sender.user_id) == 2023962344 then
msg.Name_Controller = 'Leader'
...
{
{text = '𝑺𝒐𝒖𝒓𝒄𝒆', url='https://t.me/ukkkp'},
},
}
}
...
Redis:del(FDFGERB.."FDFGERB:Add:Rd:Manager:Text"..text..msg_chat_id)   
Redis:del(FDFGERB.."FDFGERB:Add:Rd:Manager:Photo"..text..msg_chat_id)
Redis:del(FDFGERB.."FDFGERV:Add:Rd:Manager:Video"..text..msg_chat_id)
Redis:del(FDFGERB.."FDFGERB:Add:Rd:Manager:File"..text..msg_chat_id)
Redis:del(FDFGERB.."FDFGERB:Add:Rd:Manager:Audio"..text..msg_chat_id)
Redis:del(FDFGERB.."FDFGERB:Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(FDFGERB.."FDFGERB:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
...
if not Redis:sismember(FDFGERB.."htof:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• اصلا مو هطف عشان انزله ").Reply,"md",true)  
else
Redis:srem(FDFGERB.."htof:Group"..msg_chat_id,UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم تنزيله من الهطوف ").Reply,"md",true)  
end
end
end
...
if TextMsg == "هطف" then
if not Redis:sismember(FDFGERB.."htof:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• اصلا مو هطف عشان انزله  ").Reply,"md",true)  
else
Redis:srem(FDFGERB.."htof:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم تنزيله من الهطوف ").Reply,"md",true)  
end
end
end
...
if not Redis:sismember(FDFGERB.."htof:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"• اصلا مو هطف عشان انزله ").Reply,"md",true)  
else
Redis:srem(FDFGERB.."htof:Group"..msg_chat_id,UserId[2]) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"• تم تنزيله من الهطوف ").Reply,"md",true)  
end
end
end
...
if not msg.Originators and not Redis:get(FDFGERB.."FAWAZt:SetId"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"• التسليه مُعطله ما اقدر ارفع\n• لتفعيل التسليه ارسل ( تفعيل التسليه )\n༄","md",true)
end 
if Redis:sismember(FDFGERB.."htof:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم ترقيته هطف من قبل ").Reply,"md",true)  
else
Redis:sadd(FDFGERB.."htof:Group"..msg_chat_id,UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم ترقيته هطف ").Reply,"md",true)  
end
end
end
...
if Redis:sismember(FDFGERB.."htof:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم ترقيته هطف من قبل ").Reply,"md",true)  
else
Redis:sadd(FDFGERB.."htof:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم ترقيته هطف ").Reply,"md",true)  
end
end
end
...
if Redis:sismember(FDFGERB.."htof:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"• تم ترقيته هطف من قبل ").Reply,"md",true)  
else
Redis:sadd(FDFGERB.."htof:Group"..msg_chat_id,UserId[2]) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"• تم ترقيته هطف ").Reply,"md",true)  
end
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"• ماعندك 🎖Myth يالطيّب ","md",true)  
end
ListMembers = '\n• قائمه Myth🎖\n ━━━━━\n'
...
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"• ماعندك Dev يالطيّب ","md",true)  
end
ListMembers = '\n• قائمه Dev البوت \n ━━━━━\n'
for k, v in pairs(Info_Members) do
local UserInfo = LuaTele.getUser(v)
...
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {{{text = '- مسح D', data = msg.sender.user_id..'/Developers'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
...
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"• ماعندك منشئين اساسيين يالطيّب ","md",true)  
end
...
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"• ماعندك منشئين يالطيّب ","md",true)  
end
ListMembers = '\n• قائمه المنشئين  \n ━━━━━\n'
for k, v in pairs(Info_Members) do
local UserInfo = LuaTele.getUser(v)
...
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"• ماعندك مدراء يالطيّب ","md",true)  
end
ListMembers = '\n• قائمه المدراء  \n ━━━━━\n'
for k, v in pairs(Info_Members) do
local UserInfo = LuaTele.getUser(v)
...
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"• ماعندك ادمنيه يالطيّب ","md",true)  
end
ListMembers = '\n• قائمه الادمنيه  \n ━━━━━\n'
for k, v in pairs(Info_Members) do
local UserInfo = LuaTele.getUser(v)
...
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"• ماعندك مميزين يالطيّب ","md",true)  
end
ListMembers = '\n• قائمه المميزين  \n ━━━━━\n'
for k, v in pairs(Info_Members) do
local UserInfo = LuaTele.getUser(v)
...
local Info_Members = Redis:smembers(FDFGERB.."htof:Group"..msg_chat_id) 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"• ماعندك هطوف يالطيّب ","md",true)  
end
ListMembers = '\n• قائمه الهطوف \n ━━━━━\n'
for k, v in pairs(Info_Members) do
local UserInfo = LuaTele.getUser(v)
...
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {{{text = '- مسح الهطوف', data = msg.sender.user_id..'/Htof'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
...
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"• ماعندك محظورين عام يالطيّب ","md",true)  
end
ListMembers = '\n• قائمه المحظورين عام  \n ━━━━━\n'
for k, v in pairs(Info_Members) do
local UserInfo = LuaTele.getUser(v)
...
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"• ماعندك محظورين يالطيّب ","md",true)  
end
ListMembers = '\n• قائمه المحظورين  \n ━━━━━\n'
for k, v in pairs(Info_Members) do
local UserInfo = LuaTele.getUser(v)
...
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"• ماعندك مكتومين يالطيّب ","md",true)  
end
ListMembers = '\n• قائمه المكتومين  \n ━━━━━\n'
for k, v in pairs(Info_Members) do
local UserInfo = LuaTele.getUser(v)
...
return LuaTele.sendText(msg_chat_id,msg_id,"• ابشر فعلت الايدي بالصوره ","md",true)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"• ابشر فعلت الردود ","md",true)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"• ابشر فعلت الردود العامه ","md",true)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"• ابشر فعلت الرفع ","md",true)
end
...
Redis:set(FDFGERB.."FAWAZt:SetId"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"• ابشر فعلت التسليه ","md",true)
end
if TextMsg == 'الالعاب' then
Redis:set(FDFGERB.."FDFGERB:Status:Games"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"• ابشر فعلت الالعاب ","md",true)
end
if TextMsg == 'اطردني' then
Redis:set(FDFGERB.."FDFGERB:Status:KickMe"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"• ابشر فعلت امر اطردني ","md",true)
end
...
if text == 'السورس' or text == 'سورس' or text == 'ياسورس' or text == 'يا سورس' or text == 'المطور' or text == 'مطور' then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
return LuaTele.sendText(msg_chat_id,msg_id,"[𝐅𝐀𝐖𝐀𝐙](t.me/ukkkp)\n\n[عبـود ♆](t.me/IElE1)","md",true, false, false, false,reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"• ابشر عطلت لك التحقق ","md",true)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"• ابشر فعلت لك التحقق ","md",true)
end
...
Redis:del(FDFGERB.."FAWAZt:SetId"..msg_chat_id) 
...
data = {
{
{text = '- قناة السورس', url = 't.me/ukkkp'}, 
},
}
}
...
return LuaTele.sendText(msg_chat_id,msg_id,"• تم مسح ( "..#Info_Members.." ) من Dev ","md",true)
end
...
local Info_Members = Redis:smembers(FDFGERB.."htof:Group"..msg_chat_id) 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"• لا يوجد هطوف حاليا , ","md",true)  
end
Redis:del(FDFGERB.."htof:Group"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"• تم مسح ( "..#Info_Members.." ) من الهطوف ","md",true)
end
...
if text == (Redis:get(FDFGERB.."FDFGERB:Name:Bot") or "دينار") then
local NamesBot = (Redis:get(FDFGERB.."FDFGERB:Name:Bot") or "دينار")
local NameBots = {
"ياعيون "..NamesBot.."",
"كلي لك",
"عيُوني",
...
data = {
{
{text = 'موافق', data = Message_Reply.sender.user_id..'/zog11'},{text = 'مو موافق', data = Message_Reply.sender.user_id..'/zog22'}, 
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id,baniusername,"md",false, false, false, false, reply_markup)
...
if Text and Text:match('(%d+)/zog11') then
local UserId = Text:match('(%d+)/zog11')
if tonumber(IdUser) == tonumber(UserId) then
local bain = LuaTele.getUser(IdUser)
if bain.first_name then
baniusername = '*تم الزواج بنجاح \nمبروك يا  :- *['..bain.first_name..'](tg://user?id='..bain.id..')*\n༄*'
...
if Text and Text:match('(%d+)/zog22') then
local UserId = Text:match('(%d+)/zog22')
if tonumber(IdUser) == tonumber(UserId) then
...
top_mony = "توب اكثر 𝟐𝟎 شخص حرامية فلوس:\n\n"
mony_list = {}
...
if text == "التجار" or text == "توب التجار" then
...
top_mony = top_mony..emo.." *"..gflos.." 💰* ⁞ "..tt.." \n"
gflous = string.format("%d", ballancee):reverse():gsub( "(%d%d%d)" , "%1," ):reverse():gsub("^,","")
gg = " ━━━━━━━━━\n*• you)*  *"..gflous.." 💰* ⁞ "..news.." \n\n\n`ملاحظه : اي شخص يغش او يحط يوزره يُستبعد ويتعرض للحظر والتصفير !`"
end
end
...
top_mony = "توب اغنى 𝟏𝟎 زوجات بالقروب :\n\n"
mony_list = {}
for k,v in pairs(bank_users) do
...
if text == 'فلوسي' or text == 'فلوس' and
...
return LuaTele.sendText(msg.chat_id,msg.id, "⇜ ماعندك فلوس اكتب الالعاب وجمّع فلوس \n༄","md",true)
end
LuaTele.sendText(msg.chat_id,msg.id, "⇜ فلوسك `"..ballancee.."` دينار 💸\n༄","md",true)
end
...
data = {
{
{text = 'التالي', data = IdUser..'/helpall'}, {text = 'رجوع', data = IdUser..'/help3'},
},
{
{text = 'القائمه الرئيسيه', data = IdUser..'/helpall'},
},
...
٭ توب الفلوس ٭
 ...
 يطلّع لك اغنى 20 شخص معهم فلوس
ببوت دينار والسورس التابع له .. والتنافس بينهم حلو وتقدر تجمّع فلوس وتتصدر القائمه وسهلناها لكم في الاوامر التاليه :
...
وتستثمر بالفلوس .. وتاخذ مزايا كثيره
...
تستثمر بالمبلغ اللي تبيه بدون خساره
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(FDFGERB.."FDFGERB:Developers:Groups") 
LuaTele.editMessageText(ChatId,Msg_id,"• تم مسح Dev البوت", 'md', false)
end
...
elseif Text and Text:match('(%d+)/Htof') then
local UserId = Text:match('(%d+)/Htof')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(FDFGERB.."htof:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,"• تم مسح الهطوف", 'md', false)
end
