...
Bot_Name = (Redis:get(TheMero.."Mero:Name:Bot") or "نهار")
...
if UserInfo and UserInfo.type and UserInfo.type.luatele == "userTypeBot" then
send(msg.chat_id,msg.id,"\n⇜ نهار ماعندها حساب بالبنك ","md",true)  
return false
end
...
send(msg.chat_id,msg.id, "⇜ حوالة صادرة من بنك نهار\n\n⇜ المرسل ↤ "..news.."\n⇜ الحساب رقم ↤ `"..cccc.."`\n⇜ نوع البطاقة ↤ "..uuuu.."\n⇜ المستلم ↤ "..newss.."\n⇜ الحساب رقم ↤ `"..text.."`\n⇜ نوع البطاقة ↤ "..fsvhh.."\n⇜ خصمت 10% رسوم تحويل\n⇜ المبلغ ↤ "..convert_mony.." ريال 💵","md",true)
send(fsvhhh,0, "⌯ حوالة واردة من بنك نهار\n\n⇜ المرسل ↤ "..news.."\n⇜ الحساب رقم ↤ `"..cccc.."`\n⇜ نوع البطاقة ↤ "..uuuu.."\n⇜ المبلغ ↤ "..convert_mony.." ريال 💵","md",true)
Redis:del(TheMero.."trans" .. msg.chat_id .. ":" .. msg.sender_id.user_id) 
Redis:del(TheMero.."transn" .. msg.sender_id.user_id)
else
send(msg.chat_id,msg.id, "⇜ مافيه حساب بنكي كذا","md",true)
...
return send(msg.chat_id,msg.id,"⇜ قبل شوي اخذت رشوة انتظر "..time.." ","md",true)
end
...
return send(msg.chat_id,msg.id,"⇜ انت بالسجن 🏤\n⇜ انتظر "..time.." \n✧","md",true)
end
shkse = Redis:get(TheMero.."shkse"..msg.sender_id.user_id)
if shkse == "طيبة" then
...
if Redis:ttl(TheMero.."iioo" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(TheMero.."iioo" .. msg.sender_id.user_id))
return send(msg.chat_id,msg.id,"⇜ قبل شوي اخذت بخشيش انتظر "..time.." ","md",true)
end
shkse = Redis:get(TheMero.."shkse"..msg.sender_id.user_id)
if shkse == "شريرة" then
...
return send(msg.chat_id,msg.id,"⇜ انت بالسجن 🏤 انتظر "..math.floor(hours).." دقائق\n✧","md",true)
end
...
return send(msg.chat_id,msg.id,"⇜ خسرت بأخر معركة انتظر "..time.." ","md",true)
end
...
if Redis:sismember(TheMero.."booob",msg.sender_id.user_id) then
send(msg.chat_id,msg.id, "⌯ اهلا فيك بمزرعة نهار :\n\n⇜ المزروعات واسعارها :\n- بطاطا : 75 درهم 💵\n- بندوره : 100 درهم 💵\n- خس : 125 درهم 💵\n- خيار : 150 درهم 💵\n- جزر : 175 درهم 💵\n- فلفل : 200 درهم 💵\n- فريز : 300 درهم 💵\n- ذره : 400 درهم 💵\n- ثوم : 500 درهم 💵\n- فطر : 800 درهم 💵\n- شجره تفاح : 1000 درهم 💵\n- شجره عنب : 1250 درهم 💵\n-شجره زيتون : 1500 درهم 💵\n- شجره موز : 2000 درهم 💵\n- شجره مانجا : 3000 درهم 💵\n\n⇜ مثال طريقة الزراعه : \n- زراعه بطاطا 10\n- زراعه شجر موز 15\n✧","md",true)
else
send(msg.chat_id,msg.id, "⇜ ماعندك حساب بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
end
end
...
if text == 'زراعه فلفل' or text == 'زراعة فلفل' or text == 'زراعه فليفلة' or text == 'زراعة فليفلة' then
if Redis:sismember(TheMero.."booob",msg.sender_id.user_id) then
send(msg.chat_id,msg.id, "⇜ استعمل الامر كذا :\n\n⇜ `زراعه فلفل` والعدد","md",true)
else
send(msg.chat_id,msg.id, "⇜ ماعندك حساب بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
end
end
...
toplvfarmm = tonumber(toplvfarm) + tonumber(coniss)
Redis:set(TheMero.."toplvfarm"..msg.sender_id.user_id , toplvfarmm)
send(msg.chat_id,msg.id, "⇜ زرعة جزر 🥕\n⇜ العدد : "..math.floor(coniss).."\n⇜ السعر : "..convert_mony.." درهم 💵\n⇜ انتظر 40 دقيقة ⏳️ ثم قم بحصاده\n- الامر ( `حصد جزر` )\n✧","md",true)
else
send(msg.chat_id,msg.id, "⇜ ماعندك حساب بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
end
end
if text and text:match('^زراعه فلفل (.*)$') or text and text:match('^زراعة فليفله (.*)$') then

local UserName = text:match('^زراعه فليفله (.*)$') or text:match('^زراعة فلفل (.*)$')
local coniss = coin(UserName)
if Redis:sismember(TheMero.."booob",msg.sender_id.user_id) then
morakba = tonumber(Redis:get(TheMero.."morakba"..msg.sender_id.user_id))
if morakba == msg.sender_id.user_id then
...
return send(msg.chat_id,msg.id, "⇜ زرعة فلفل قبل 🫑\n⇜ انتظر "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصادها\n- طريقة الحصاد بالامر : `حصد فلفل`","md",true)
end
...
toplvfarmm = tonumber(toplvfarm) + tonumber(coniss)
Redis:set(TheMero.."toplvfarm"..msg.sender_id.user_id , toplvfarmm)
send(msg.chat_id,msg.id, "⇜ زرعة فلفل 🫑\n⇜ العدد : "..math.floor(coniss).."\n⇜ السعر : "..convert_mony.." درهم 💵\n⇜ انتظر 45 دقيقة ⏳️ ثم قم بحصادها\n- الامر ( `حصد فلفل` )\n✧","md",true)
else
send(msg.chat_id,msg.id, "⇜ ماعندك حساب بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
end
end
...
if text == 'حصد فلفل' or text == 'حصاد فلفل' or text == 'حصد الفليفله' or text == 'حصاد الفليفله' then
...
return send(msg.chat_id,msg.id, "⇜ ليس لديك مزروعات فلفل 🫑\n⇜ تستطيع زراعتها بالامر ( `زراعه فلفل` )\n✧","md",true)
end
if Redis:get(TheMero.."fleflatime"..msg.sender_id.user_id) then
local hours = Redis:ttl(TheMero.."fleflatime".. msg.sender_id.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ لم تنضج فلفل بمزرعتك 🫑\n⇜ انتظر "..math.floor(hours).." دقيقة ⏳\n✧️","md",true)
end
ballance = Redis:get(TheMero.."boob"..msg.sender_id.user_id) or 0
...
send(msg.chat_id,msg.id, "⇜ تم حصاد فلفل 🫑\n⇜ العدد : "..math.floor(fleflanum).."\n⇜ السعر : "..convert_mony.." درهم 💵\n⇜ رصيدك الان : "..convert_monyy.." درهم 💵\n✧","md",true)
mzroatsize = Redis:get(TheMero.."mzroatsize"..msg.sender_id.user_id) or 0
...
bot.sendAudio(msg.chat_id,msg.id,'./intk'..rand..'.mp3',tostring(inoi),"html",nil,tostring(inoi),"@zrt3i")
sleep(1)
...
if Redis:ttl(TheMero.."iioood" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(TheMero.."iioood" .. msg.sender_id.user_id))
return send(msg.chat_id,msg.id,"⇜ قبل شوي عملت سحب انتظر "..time.." ","md",true)
end
ballanceed = Redis:get(TheMero.."boob"..msg.sender_id.user_id) or 0
if tonumber(coniss) > 1000000001 then
...
local UserInfo = bot.getUser(Remsg.sender_id.user_id)
if UserInfo and UserInfo.type and UserInfo.type.luatele == "userTypeBot" then
send(msg.chat_id,msg.id,"\n⇜ نهار ماعنده حساب بالبنك ","md",true)  
return false
end
if Redis:sismember(TheMero.."booob",Remsg.sender_id.user_id) then
ballanceed = Redis:get(TheMero.."boob"..Remsg.sender_id.user_id) or 0
