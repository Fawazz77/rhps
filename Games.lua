...
local Bot_Name = (Redis:get(TheMero.."Mero:Name:Bot") or "نهار")
...
keyboard.inline_keyboard = {
{
{text = 'السورس', url = "https://t.me/zrt3i"}
},
}
