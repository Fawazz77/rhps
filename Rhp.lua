...
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.voice_note then
local tect = Redis:get(TheRhp.."Rhp:Text:Manager"..msg.sender.user_id..":"..msg_chat_id)
if Redis:get(TheRhp.."Rhp:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(TheRhp.."Rhp:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
...
{{text =news,url = "https://t.me/ukkkp"}, },}}
...
if text and text:match("^(.*)$") then
if redis:get(TheRhp.."Set:array"..msg.sender.user_id..":"..msg.chat_id) == 'true' then
redis:set(TheRhp..'Set:array'..msg.sender.user_id..':'..msg.chat_id,'true1')
redis:set(TheRhp..'Text:array'..msg.sender.user_id..':'..msg.chat_id, text)
redis:del(TheRhp.."Add:Rd:array:Text"..text..msg.chat_id)   
redis:sadd(TheRhp..'List:array'..msg.chat_id..'', text)
return LuaTele.sendText(msg.chat_id,msg.id,"⇜ ارسل الكلمه الرد الذي تريد اضافتها","md",true)  
return false
end
end
if text and redis:get(TheRhp..'Set:array'..msg.sender.user_id..':'..msg.chat_id) == 'true1' then
local test = redis:get(TheRhp..'Text:array'..msg.sender.user_id..':'..msg.chat_id..'')
text = text:gsub('"','') 
text = text:gsub("'",'') 
text = text:gsub('`','') 
text = text:gsub('*','') 
redis:sadd(TheRhp.."Add:Rd:array:Text"..test..msg.chat_id,text)
reply_ad = bot.replyMarkup{
type = 'inline',data = {
{{text="اضغط هنا لانهاء الاضافة",data="EndAddarray"..msg.sender.user_id}},
}
}
return LuaTele.sendText(msg.chat_id,msg.id,'⇜ تم حفظ الرد يمكنك ارسال اخر او اكمال العمليه من خلال الزر اسفل ✅',"md",true, false, false, false, reply_ad)
end
if text and text:match("^(.*)$") then
if redis:get(TheRhp.."Set:array:Ssd"..msg.sender.user_id..":"..msg.chat_id) == 'dttd' then
redis:del(TheRhp.."Set:array:Ssd"..msg.sender.user_id..":"..msg.chat_id)
gery = redis:get(TheRhp.."Set:array:addpu"..msg.sender.user_id..":"..msg.chat_id)
if not redis:sismember(TheRhp.."Add:Rd:array:Text"..gery..msg.chat_id,text) then
LuaTele.sendText(msg.chat_id,msg.id,"⇜ لا يوجد رد متعدد ","md",true)  
return false
end
redis:srem(TheRhp.."Add:Rd:array:Text"..gery..msg.chat_id,text)
LuaTele.sendText(msg.chat_id,msg.id,'⇜ تم حذفه بنجاح ',"md",true)  
end
end
if text and text:match("^(.*)$") then
if redis:get(TheRhp.."Set:array:Ssd"..msg.sender.user_id..":"..msg.chat_id) == 'delrd' then
redis:del(TheRhp.."Set:array:Ssd"..msg.sender.user_id..":"..msg.chat_id)
if not redis:sismember(TheRhp..'List:array'..msg.chat_id,text) then
LuaTele.sendText(msg.chat_id,msg.id,"⇜ لا يوجد رد متعدد ","md",true)  
return false
end
redis:set(TheRhp.."Set:array:addpu"..msg.sender.user_id..":"..msg.chat_id,text)
redis:set(TheRhp.."Set:array:Ssd"..msg.sender.user_id..":"..msg.chat_id,"dttd")
LuaTele.sendText(msg.chat_id,msg.id,'⇜ قم بارسال الرد الذي تريد حذفه منه ',"md",true)  
return false
end
end
...
redis:set(TheRhp.."Set:array:Ssd"..msg.sender.user_id..":"..msg.chat_id,"delrd")
return LuaTele.sendText(msg.chat_id,msg.id,"⇜ ارسل الكلمه الرد الاصليه","md",true)  
return false
end
if text and text:match("^(.*)$") then
if redis:get(TheRhp.."Set:array:rd"..msg.sender.user_id..":"..msg.chat_id) == 'delrd' then
redis:del(TheRhp.."Set:array:rd"..msg.sender.user_id..":"..msg.chat_id)
redis:del(TheRhp.."Add:Rd:array:Text"..text..msg.chat_id)
redis:srem(TheRhp..'List:array'..msg.chat_id, text)
LuaTele.sendText(msg.chat_id,msg.id,"⇜ تم حذف الرد المتعدد بنجاح*","md",true)  
return false
end
end
...
redis:set(TheRhp.."Set:array:rd"..msg.sender.user_id..":"..msg.chat_id,"delrd")
return LuaTele.sendText(msg.chat_id,msg.id,"⇜ ارسل الان الكلمه لحذفها من الردود","md",true)  
return false
end
if text == ("الردود المتعددة") then
if not msg.Managers then
return LuaTele.sendText(msg_chat_id,msg_id,'\n⇜ هاذا الامر يخص ( '..Controller_Num(6)..' ) ',"md",true)  
end 
local list = redis:smembers(TheRhp..'List:array'..msg.chat_id..'')
...
if text == ("مسح الردود المتعددة") then
if not msg.Managers then
return LuaTele.sendText(msg_chat_id,msg_id,'\n⇜ هاذا الامر يخص ( '..Controller_Num(6)..' ) ',"md",true)  
end 
local list = redis:smembers(TheRhp..'List:array'..msg.chat_id)
for k,v in pairs(list) do
redis:del(TheRhp.."Add:Rd:array:Text"..v..msg.chat_id)   
redis:del(TheRhp..'List:array'..msg.chat_id)
end
return LuaTele.sendText(msg.chat_id,msg.id,"⇜ تم مسح الردود المتعددة","md",true)  
end
if text == "اضف رد متعدد" then   
if not msg.Managers then
return LuaTele.sendText(msg_chat_id,msg_id,'\n⇜ هاذا الامر يخص ( '..Controller_Num(6)..' ) ',"md",true)  
end
return LuaTele.sendText(msg.chat_id,msg.id,"⇜ ارسل الان الكلمه لاضافتها في الردود","md",true)
redis:set(TheRhp.."Set:array"..msg.sender.user_id..":"..msg.chat_id,true)
return false 
end
end
...
{
{text = 'السورس', url = "https://t.me/kkznk"}
},
}
...
top_mony = "توب اغنى 𝟐𝟎 شخص بالفلوس\n\n"
mony_list = {}
for k,v in pairs(bank_users) do
...
return LuaTele.sendText(msg.chat_id,msg.id, "⇜ استثمار ناجحه 2x\n⇜ نسبة الربح ↢ 10%\n⇜ مبلغ الربح ↢ ⦗ "..ballanceekk.." دينار 💸 ⦘\n⇜ فلوسك صارت ↢ ⦗ "..ballanceekkk.." دينار 💸 ⦘\n༄","md",true)
end
...
Redis:incrby(TheRhp.."nool:flotysb"..msg.sender.user_id , math.floor(ballanceekk))
Redis:setex(TheRhp.."nnoooo" .. msg.sender.user_id,1200, true)
LuaTele.sendText(msg.chat_id,msg.id, "⇜ استثمار ناجحه \n⇜ نسبة الربح ↢ "..hadddd.."%\n⇜ مبلغ الربح ↢ ⦗ "..ballanceekk.." دينار 💸 ⦘\n⇜ فلوسك صارت ↢ ⦗ "..ballanceekkk.." دينار 💸 ⦘\n༄","md",true)
else
LuaTele.sendText(msg.chat_id,msg.id, "⇜ ماعندك حساب بنكي\n⇜ اكتب ( `انشاء حساب بنكي` )","md",true)
end
end
...
if redis:get(TheRhp..'Set:array'..user_id..':'..chat_id) == 'true1' then
redis:del(TheRhp..'Set:array'..user_id..':'..chat_id)
LuaTele.editMessageText(chat_id,msg_id,"⇜ تم حفظ الردود بنجاح", 'md', true, false, reply_markup)
else
LuaTele.editMessageText(chat_id,msg_id,"⇜ تم تنفيذ الامر سابقا", 'md', true, false, reply_markup)
end
end
