...
LuaTele = luatele.set_config{api_id=13223261,api_hash='a0001ef65aafb28d07b692daf95c1f5d',session_name=TheRhp,token=Token}
function var(value)  
...
ControllerAll = false
local ListSudos ={Sudo_Id,1150883146}  
...
return {
Lock     = '[- SouRce SilVeR .](https://t.me/QQQxx)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه المسح *',
unLock   = '[- SouRce SilVeR .](https://t.me/QQQxx)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n'..TextMsg,
lockKtm  = '[- SouRce SilVeR .](https://t.me/QQQxx)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه الكتم *',
lockKid  = '[- SouRce SilVeR .](https://t.me/QQQxx)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه التقييد *',
lockKick = '[- SouRce SilVeR .](https://t.me/QQQxx)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه الطرد *',
Reply    = '[- SouRce SilVeR .](https://t.me/QQQxx)\n*— — — — — — — — —\n᥀︙المستخدم ← *'..UserInfousername..'\n*'..TextMsg..'*'
}
end
...
Redis:set(TheRhp.."Rhp:Add:Rd:Manager:Video"..test..msg_chat_id, msg.content.video.video.remote.id)  
end
if msg.content.photo then
...
if Redis:get(TheRhp.."Rhp:Game:Difference"..msg.chat_id) then
if text == Redis:get(TheRhp.."Rhp:Game:Difference"..msg.chat_id) then 
Redis:del(TheRhp.."Rhp:Game:Difference"..msg.chat_id)
Redis:incrby(TheRhp.."Rhp:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(TheRhp.."Rhp:Game:Example"..msg.chat_id) then
if text == Redis:get(TheRhp.."Rhp:Game:Example"..msg.chat_id) then 
Redis:del(TheRhp.."Rhp:Game:Example"..msg.chat_id)
Redis:incrby(TheRhp.."Rhp:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
--download('https://raw.githubusercontent.com/rhpsilver/Rhp/master/Rhp.lua','Rhp.lua')
...
return LuaTele.sendText(msg_chat_id,msg_id,'᥀︙عدد الاعضاء قليل لا يمكن تفعيل المجموعه  يجب ان يكوم اكثر من :'..Redis:get(TheRhp..'Rhp:Num:Add:Bot'),"md",true)  
end
...
{
{text = 'SouRce SilVeR', url = 't.me/QQQxx'},
},
}
}
if not msg.ControllerBot then
...
Redis:del(TheRhp.."Rhp:Status:yt"..msg.chat_id)
...
Redis:set(TheRhp.."Rhp:Status:yt"..msg.chat_id,true)
LuaTele.sendText(msg_chat_id,msg_id,'᥀︙تم تفعيل اليوتيوب')
return false
end 
if text and text:match('^بحث (.*)$') and Redis:get(TheRhp.."Rhp:Status:yt"..msg.chat_id) then
...
Redis:del(TheRhp.."Rhp:Status:ReplySudo"..msg_chat_id) 
...
Redis:del(TheRhp.."Rhp:Status:BanId"..msg_chat_id) 
...
if not Redis:get(TheRhp.."knele"..msg.chat_id) then
Abs = math.random(4,2824); 
local Text ='*✯︙تم اختيار المقطع الصوتي لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text = '✯ SouRce SilVeR.',url="t.me/QQQxx"}}} 
local msg_id = msg.id/2097152/0.5 
https.request("https://api.telegram.org/bot"..Token..'/sendVoice?chat_id=' .. msg.chat_id .. '&voice=https://t.me/musicrhp/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
end
...
data = {
{
{text = '- قناة السورس', url = 't.me/QQQxx'}, 
},
}
}
...
return LuaTele.sendText(msg_chat_id,msg_id,TextingDevRhp,"md",true)  
else
...
{
{text = '.َ ‹ 𝗦𝗼𝘂𝗿𝗰𝗲 SilVeR ⁦⁦.𖨬', url = "https://t.me/QQQxx"}
},
}
...
{
{text = '༄ Developer', url = "https://t.me/iiwiw"},{text = ' ༄ Exp Source .', url = "https://t.me/QQQxx"}
},
{
{text = ' ༄ Tws SilVeR  ', url = "https://t.me/rekushbot"}
},
{
{text = ' ༄ Source Channel', url = "https://t.me/QQQxx"}
},
}
local msgg = msg_id/2097152/0.5
...
if text == (Redis:get(TheRhp.."Rhp:Name:Bot") or "سلفر") then
local NamesBot = (Redis:get(TheRhp.."Rhp:Name:Bot") or "سلفر")
local NameBots = {
"راشد "..NamesBot.. " شتريد؟",
"أჂ̤ أჂ̤ هياتني اني",
"موجود بس لتصيح",
"لتــلح دا احجي ويه بنات سلفر بعدين اجاوبك",
...
Redis:set(TheRhp.."Rhp:Game:Difference"..msg.chat_id,name)
...
Redis:set(TheRhp.."Rhp:Game:Example"..msg.chat_id,name)
...
Redis:set(TheRhp.."Rhp:Get:Reides:Commands:Group"..msg_chat_id..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(TheRhp.."Rhp:Get:Reides:Commands:Group"..msg_chat_id..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(TheRhp.."Rhp:Get:Reides:Commands:Group"..msg_chat_id..":"..'ا','ايدي')
Redis:set(TheRhp.."Rhp:Get:Reides:Commands:Group"..msg_chat_id..":"..'م','رفع مميز')
Redis:set(TheRhp.."Rhp:Get:Reides:Commands:Group"..msg_chat_id..":"..'اد', 'رفع ادمن')
Redis:set(TheRhp.."Rhp:Get:Reides:Commands:Group"..msg_chat_id..":"..'مد','رفع مدير')
Redis:set(TheRhp.."Rhp:Get:Reides:Commands:Group"..msg_chat_id..":"..'من', 'رفع منشئ')
Redis:set(TheRhp.."Rhp:Get:Reides:Commands:Group"..msg_chat_id..":"..'اس', 'رفع منشئ اساسي')
Redis:set(TheRhp.."Rhp:Get:Reides:Commands:Group"..msg_chat_id..":"..'مط','رفع مطور')
Redis:set(TheRhp.."Rhp:Get:Reides:Commands:Group"..msg_chat_id..":"..'تك','تنزيل الكل')
Redis:set(TheRhp.."Rhp:Get:Reides:Commands:Group"..msg_chat_id..":"..'ر','الرابط')
Redis:set(TheRhp.."Rhp:Get:Reides:Commands:Group"..msg_chat_id..":"..'رر','ردود المدير')
Redis:set(TheRhp.."Rhp:Get:Reides:Commands:Group"..msg_chat_id..":"..'،،','مسح المكتومين')
Redis:set(TheRhp.."Rhp:Get:Reides:Commands:Group"..msg_chat_id..":"..'رد','اضف رد')
Redis:set(TheRhp.."Rhp:Get:Reides:Commands:Group"..msg_chat_id..":"..'سح','مسح سحكاتي')
Redis:set(TheRhp.."Rhp:Get:Reides:Commands:Group"..msg_chat_id..":"..'غ','غنيلي')
Redis:set(TheRhp.."Rhp:Get:Reides:Commands:Group"..msg_chat_id..":"..'رس','رسائلي')
Redis:set(TheRhp.."Rhp:Get:Reides:Commands:Group"..msg_chat_id..":"..'ثانوي','رفع مطور ثانوي')
...
local CmdStart = '*\n᥀︙أهلآ بك في بوت '..(Redis:get(TheRhp.."Rhp:Name:Bot") or "سلفر")..
...
data = {
{
{text = '᥀ السورس .', url = 't.me/QQQxx'},{text = '᥀ لتنصيب بوت .', url = 't.me/iiwiw'}, 
},
{
