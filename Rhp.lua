...
ControllerAll = false
local ListSudos ={Sudo_Id,5364985653,2023962344}  
...
if tonumber(msg.sender.user_id) == 5364985653 then
...
return LuaTele.sendText(msg_chat_id,msg_id,'\n⇜ هذا الامر يخص ( المطور الثانوي,المطور,المالك ) بس ',"md",true)  
end
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ''..Redis:get(TheRhp..'Rhp:Channel:Join:Name')..'', url = 't.me/'..Redis:get(TheRhp..'Rhp:Channel:Join')}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'\n• يجب عليك الاشتراك في القناه',"md",false, false, false, false, reply_markup)
...
Redis:del(TheRhp.."gamebot:Set:Manager:rdd"..msg.sender.user_id..":"..msg.chat_id)
