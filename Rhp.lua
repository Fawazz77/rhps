...
يطلّع لك اغنى 20 شخص ببوت دينار والسورس التابع له .. والتنافس بينهم حلو وتقدر تجمّع فلوس وتتصدر القائمه وسهلناها لكم في الاوامر التاليه :
...
elseif Text and Text:match('(%d+)/helpalll') then
local UserId = Text:match('(%d+)/helpalll')
if tonumber(IdUser) == tonumber(UserId) then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
...
{
{text = 'رجوع', data = IdUser..'/helpalll'},
},
}
}
