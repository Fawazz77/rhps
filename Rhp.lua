...
ControllerAll = false
local ListSudos ={Sudo_Id,5124711331,2023962344}  
...
msg.Name_Controller = 'الهكر فواز '
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 2023962344 then
...
if text == 
Redis:get(TheRhp.."Rhp:Game:Monotonous"..msg.chat_id) then
...
if text == 
Redis:get(TheRhp.."Rhp:Game:jkl"..msg.chat_id) then
...
if text == 
Redis:get(TheRhp.."Rhp:Game:iuy"..msg.chat_id) then
...
return LuaTele.sendText(msg_chat_id,msg_id,ramsesj20)
end
...
Redis:set(TheRhp.."Abs:Nsba:Abs"..msg_chat_id,true) 
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"⇜ ابشر فعلت النسب").Lock,"md",true)  
return false
end 
...
if text == 'احفظ' then
Redis:del(TheRhp.."Rhp1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id)
Redis:del(TheRhp.."Rhp11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id)
LuaTele.sendText(msg_chat_id,msg_id,'تم حفظ جميع الردود العشوائيه بنجاح .')
return false
end
if text and text:match("^(.*)$") then
...
data = {
{
{text = '', data = msg.sender.user_id..'/chengreplygg'},
},
{
{text = '', data = msg.sender.user_id..'/delamrredis'},
},
{
{text = '', url='https://t.me/ukkkp'},
},
}
}
return  LuaTele.sendText(msg_chat_id,msg_id, '\n⇜ تمام ياحلو ارسل الرد الاول\n⇜ اذا خلصت ارسل ( احفظ )',"md",true, false, false, false, reply_markup) 
end
end
if text and text:match("^(.*)$") then
...
Redis:del(TheRhp..'Rhp1:Add:Rd:Sudo:Text3'..text..msg.chat_id)
Redis:del(TheRhp..'Rhp1:Add:Rd:Sudo:Text4'..text..msg.chat_id)
Redis:del(TheRhp..'Rhp1:Add:Rd:Sudo:Text5'..text..msg.chat_id)
Redis:del(TheRhp..'Rhp1:Add:Rd:Sudo:Text6'..text..msg.chat_id)
Redis:del(TheRhp..'Rhp1:Add:Rd:Sudo:Text7'..text..msg.chat_id)
Redis:del(TheRhp..'Rhp1:Add:Rd:Sudo:Text8'..text..msg.chat_id)
Redis:del(TheRhp..'Rhp1:Add:Rd:Sudo:Text9'..text..msg.chat_id)
Redis:del(TheRhp.."Rhp1:Set:On"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(TheRhp.."Rhp1:List:Rd:Sudo"..msg.chat_id, text)
return  LuaTele.sendText(msg_chat_id,msg_id,"⇜ تم حذف الرد من ردود العشوائيه")
end
end
...
Redis:del(TheRhp.."Rhp1:Add:Rd:Sudo:Text3"..v..msg.chat_id) 
Redis:del(TheRhp.."Rhp1:Add:Rd:Sudo:Text4"..v..msg.chat_id) 
Redis:del(TheRhp.."Rhp1:Add:Rd:Sudo:Text5"..v..msg.chat_id) 
Redis:del(TheRhp.."Rhp1:Add:Rd:Sudo:Text6"..v..msg.chat_id) 
Redis:del(TheRhp.."Rhp1:Add:Rd:Sudo:Text7"..v..msg.chat_id) 
Redis:del(TheRhp.."Rhp1:Add:Rd:Sudo:Text8"..v..msg.chat_id) 
Redis:del(TheRhp.."Rhp1:Add:Rd:Sudo:Text9"..v..msg.chat_id) 
Redis:del(TheRhp.."Rhp1:List:Rd:Sudo"..msg.chat_id)
end
 LuaTele.sendText(msg_chat_id,msg_id,"تم حذف ردود العشوائيه")
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"⇜ حلو , ارسل الرد العشوائي لاضافته ","md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"⇜ حلو , ارسل الرد العشوائي لحذفه ","md",false, false, false, false, reply_markup)
end
if text then  
...
Redis:set(TheRhp.."Rhp1:Add:Rd:Sudo:Text"..test..msg.chat_id, text)  
 ...
 LuaTele.sendText(msg_chat_id,msg_id,"⇜ تم حفظ الرد الاول\n⇜ اذا خلصت ارسل احفظ")
return false
end
end
if text then  
...
Redis:set(TheRhp.."Rhp1:Add:Rd:Sudo:Text1"..test..msg.chat_id, text)  
 ...
 LuaTele.sendText(msg_chat_id,msg_id,"⇜ تم حفظ الرد الثاني\n⇜ اذا خلصت ارسل احفظ")
return false
end
end
if text then  
...
Redis:set(TheRhp.."Rhp1:Add:Rd:Sudo:Text2"..test..msg.chat_id, text)  
 ...
 LuaTele.sendText(msg_chat_id,msg_id,"⇜ تم حفظ الرد الثالث\n⇜ اذا خلصت ارسل احفظ")
return false
end
end
if text then  
local test = Redis:get(TheRhp.."Rhp1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheRhp.."Rhp1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd3" then
Redis:set(TheRhp.."Rhp1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd4')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheRhp.."Rhp1:Add:Rd:Sudo:Text3"..test..msg.chat_id, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"⇜ تم حفظ الرد الرابع\n⇜ اذا خلصت ارسل احفظ")
return false
end
end
if text then  
local test = Redis:get(TheRhp.."Rhp1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheRhp.."Rhp1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd4" then
Redis:set(TheRhp.."Rhp1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd5')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheRhp.."Rhp1:Add:Rd:Sudo:Text4"..test..msg.chat_id, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"⇜ تم حفظ الرد الخامس\n⇜ اذا خلصت ارسل احفظ")
return false
end
end
if text then  
local test = Redis:get(TheRhp.."Rhp1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheRhp.."Rhp1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd5" then
Redis:set(TheRhp.."Rhp1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd6')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheRhp.."Rhp1:Add:Rd:Sudo:Text5"..test..msg.chat_id, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"⇜ تم حفظ الرد السادس\n⇜ اذا خلصت ارسل احفظ")
return false
end
end
if text then  
local test = Redis:get(TheRhp.."Rhp1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheRhp.."Rhp1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd6" then
Redis:set(TheRhp.."Rhp1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd7')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheRhp.."Rhp1:Add:Rd:Sudo:Text6"..test..msg.chat_id, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"⇜ تم حفظ الرد السابع\n⇜ اذا خلصت ارسل احفظ")
return false
end
end
if text then  
local test = Redis:get(TheRhp.."Rhp1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheRhp.."Rhp1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd7" then
Redis:set(TheRhp.."Rhp1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd8')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheRhp.."Rhp1:Add:Rd:Sudo:Text7"..test..msg.chat_id, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"⇜ تم حفظ الرد الثامن\n⇜ اذا خلصت ارسل احفظ")
return false
end
end
if text then  
local test = Redis:get(TheRhp.."Rhp1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheRhp.."Rhp1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd8" then
Redis:set(TheRhp.."Rhp1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd9')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheRhp.."Rhp1:Add:Rd:Sudo:Text8"..test..msg.chat_id, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"⇜ تم حفظ الرد التاسع\n⇜ اذا خلصت ارسل احفظ")
return false
end
end
if text then  
local test = Redis:get(TheRhp.."Rhp1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheRhp.."Rhp1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd9" then
Redis:set(TheRhp.."Rhp1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd10')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheRhp.."Rhp1:Add:Rd:Sudo:Text9"..test..msg.chat_id, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"⇜ ابشر حفظت الردود العشوائيه")
return false
end
end
if text then
...
local Text3 = Redis:get(TheRhp.."Rhp1:Add:Rd:Sudo:Text3"..text..msg.chat_id)   
local Text4 = Redis:get(TheRhp.."Rhp1:Add:Rd:Sudo:Text4"..text..msg.chat_id)   
local Text5 = Redis:get(TheRhp.."Rhp1:Add:Rd:Sudo:Text5"..text..msg.chat_id)   
local Text6 = Redis:get(TheRhp.."Rhp1:Add:Rd:Sudo:Text6"..text..msg.chat_id)   
local Text7 = Redis:get(TheRhp.."Rhp1:Add:Rd:Sudo:Text7"..text..msg.chat_id)   
local Text8 = Redis:get(TheRhp.."Rhp1:Add:Rd:Sudo:Text8"..text..msg.chat_id)   
local Text9 = Redis:get(TheRhp.."Rhp1:Add:Rd:Sudo:Text9"..text..msg.chat_id)   
...
if Redis:get(TheRhp.."Rhp11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
 LuaTele.sendText(msg_chat_id,msg_id, '\nارسل لي الكلمه الان ')
Redis:set(TheRhp.."Rhp11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(TheRhp.."Rhp11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(TheRhp.."Rhp11:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if Redis:get(TheRhp.."Rhp11:Set:On"..msg.sender.user_id..":"..msg.chat_id) == "true" then
 LuaTele.sendText(msg_chat_id,msg_id,"تم حذف الرد من ردود المتعدده")
Redis:del(TheRhp..'Rhp11:Add:Rd:Sudo:Text'..text)
Redis:del(TheRhp..'Rhp11:Add:Rd:Sudo:Text1'..text)
Redis:del(TheRhp..'Rhp11:Add:Rd:Sudo:Text2'..text)
Redis:del(TheRhp.."Rhp11:Set:On"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(TheRhp.."Rhp11:List:Rd:Sudo", text)
return false
end
end
...
local list = Redis:smembers(TheRhp.."Rhp11:List:Rd:Sudo")
for k,v in pairs(list) do  
Redis:del(TheRhp.."Rhp11:Add:Rd:Sudo:Text"..v) 
Redis:del(TheRhp.."Rhp11:Add:Rd:Sudo:Text1"..v) 
Redis:del(TheRhp.."Rhp11:Add:Rd:Sudo:Text2"..v)   
Redis:del(TheRhp.."Rhp11:List:Rd:Sudo")
end
...
Redis:set(TheRhp.."Rhp11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
...
Redis:set(TheRhp.."Rhp11:Set:On"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = Redis:get(TheRhp.."Rhp11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheRhp.."Rhp11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(TheRhp.."Rhp11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheRhp.."Rhp11:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text then  
local test = Redis:get(TheRhp.."Rhp11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheRhp.."Rhp11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(TheRhp.."Rhp11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheRhp.."Rhp11:Add:Rd:Sudo:Text1"..test, text)  
end  
...
if text then  
local test = Redis:get(TheRhp.."Rhp11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheRhp.."Rhp11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(TheRhp.."Rhp11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheRhp.."Rhp11:Add:Rd:Sudo:Text2"..test, text)  
end  
...
if text then
local Text = Redis:get(TheRhp.."Rhp11:Add:Rd:Sudo:Text"..text)   
local Text1 = Redis:get(TheRhp.."Rhp11:Add:Rd:Sudo:Text1"..text)   
local Text2 = Redis:get(TheRhp.."Rhp11:Add:Rd:Sudo:Text2"..text)   
...
local TextingDevTheRhp = Redis:get(TheRhp..'Rhp:Texting:DevTheRhp')
if TextingDevTheRhp then 
return LuaTele.sendText(msg_chat_id,msg_id,TextingDevTheRhp,"md",true)  
else
...
data = {
{
{text = '𝐃𝐞𝐯', url = 't.me/ukkkp'}, 
},
{
{text = '𝐃𝐞𝐯', url = 't.me/IElE1'}, 
},
}
}
...
data = {
{
{text = 'الالعاب انلاين', data = msg.sender.user_id..'/help5'}, {text = 'لعبه البنك', data = msg.sender.user_id..'/help6'}, 
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id, [[
...
if Redis:get(TheRhp.."Rhp:Status:Games"..msg.chat_id) then
local texting = {"نسبة رضاك عن الأشخاص من حولك هالفترة ؟",
...
"اول ولد لك وش واح تسميه ؟",
"تفضّل النقاش الطويل او تحب الاختصار ؟",
"وش أخر شي ضيعته ؟",
"عادي تتزوج من برا القبيله ؟",
"كم مره حبيت ؟",
"تبادل الكراهية بالكراهية؟ ولا تحرجه بالطيب ؟",
"قلبي على قلبك مهما صار تقولها لمين ؟",
"اكثر المتابعين عندك باي برنامج ؟",
"نسبه النُعاس عندك حاليًا ؟",
"تجامل الناس ولا اللي بقلبك على لسانك ؟",
"عمرك ضحيت لأجل شخص ما يسوى ؟",
"مُغني تلاحظ أن صوته يعجب الجميع إلا أنت ؟",
"أخر غلطات عمرك ؟",
...
"يوم لا يُمكنك نسيانه ؟",
"شعورك الحالي في كلمة ؟",
"أكثر سبب منطقي يمكن أن يجعلك تقرر الإبتعاد عن الشخص الذي تُحب ؟",
"كلمة لشخص بعيد ؟",
"صفه يُطلقها عليك شخصك المُفضل ؟",
...
"وانت حزين اول شخص تتصل عليه ؟",
"شخص تقدر تفضفض له وانت مرتاح ؟",
"موقف مُستحيل تنساه ؟",
"كم تشوف نفسك تستحق فُرصه ؟",
"يهمك كلام الناس ولا أخر همك ؟",
...
"اعترف باي حاجه ؟",
"عبّر عن مودك بصوره ؟",
"اشياء تفتخر انك ماسويتها ؟",
"تحب تحتفظ بالذكريات ؟",
"اغلب وقتك ضايع في ؟",
"اكثر كلمة تنقال لك بالبيت ؟",
"كلمتك التسليكيه ؟",
"تزعلك الدنيا وترضيك ؟",
"عندك فوبيا او خوف شديد من شيء مُعين ؟",
"غزل بلهجتك ؟",
...
"من طلاسم لهجتكم ؟",
"موقف مُحرج ماتنساه ؟",
,"تؤمن بمقولة إنسان يُنسيك إنسان ؟"
,"اسم كتاب أو رواية أثرت بك ؟"
,"هل الكبرياء يقتل الحُب ؟"
,"هل تفضّل المجاملة عادة على أن تكون صريح وتجرح الشخص ؟"
,"هل تتذكر نوع أول سيارة قمت بقيادتها ؟"
,"هل لديك مناسبة سعيدة قريبة ؟"
,"السفر الدائم أم الاستقرار ؟"
,"هل تحب تسلق الجبال؟ أم مغامرات أخرى ؟"
,"هل أصبحت متبلدًا من الأخبار والأحداث ؟"
,"جنسية تود لو تحصل عليها غير جنسيتك ؟"
,"اسم قرييب من قلبك؟ مع السبب ؟"
,"ما الذي يُبهرك دائمًا ؟"
,"حياتك ضاعت على ... ؟"
,"صورة لها ذكرى جميلة عندك ؟"
,"كيف تبدأ يومك عادة ؟"
,"برأيك، هل مواقع التواصل الاجتماعي  زادت من ثقافة المجتمع أم سرقة وقت الفرد لا غير ؟"
,"حدث حصل في حياتك وغيرها للأفضل ؟"
,"يُوتيوبر يعجبك مايُقدمه ؟"
,"هدف قريب تعمل على تحقيقه ؟"
,"هل بتجبر عيالك على فكر مُعين ؟"
,"بيت شعر اعجبك ؟"
,"مكان قديم تشتاق لزيارته ؟"
,"عندك تجربة في سوق العملات الرقمية ؟"
,"هل وجدت ذلك الشخص الذي يُشبهك في الكثير من الأمور ؟"
,"شخص لن يُكرره التاريخ ؟"
,"أنقطع النت عن العالم , ماذا تفعل ؟"
,"برأيك، كيف يكون الحب الحقيقي وكيف تتم المحافظة عليه ؟"
,"ماذا ستفعل لو تحولت كراهيتك لعدوك إلى محبة، لكنه لا يفهمك ؟"
,"وظيفة تعتقد أنها تناسبك وتناسب شخصيتك ؟"
,"شيء يُخرجك عن شعورك ؟"
,"أوقات لاتحب أن يُكلمك فيها احد ؟"
,"متى تضع النقطة في علاقاتك ؟"
,"ما هو الشيء الذي لا يستطيع قلبك مقاومته ؟"
,"افضل نوع طيور يُمكن تربيته ؟"
,"هل يوجد لديك نوع معين من الموسيقى تفضّله أم لا تهتم ؟"
,"أجمل بلد أوروبي زرته ؟"
,"أخر انجازاتك ؟"
,"لماذا يكره الانسان الحقيقه ؟"
,"أقوى جملة تحفيزية بالنسبة لك ؟"
,"كم لغة تُجيد؟ وهل تخطط لتعلم لغة معينة ؟"
,"شخص أساء إليك كثيرًا، ترد الأمر نفسه إليه أم لكَ تعامل آخر ؟"
,"لا استطيع ان اكره .... ؟"
,"هل حدث وشعرت بالوحدة رغم وجود الجميع مِن حولك ؟"
,"أقرب شخص لك مِن العائلة ؟"
,"لماذا يُقال غالبًا بأن الرجال خائنون ؟"
,"هل سبق وأعطيت شخص أكبر من حجمه ثم ندمت ؟"
,"صفة تتمنى أن تكون في شخصيتك ؟"
,"ما الذي يمكن أن نتعلمه من الأطفال ؟"
"تخطط لمستقبلك ولا ؟",
"وقفة إحترام للي اخترع ؟",
"أسم ماتحبه ؟",
"كل شي يهون الا ؟",
"يومك ضاع على ... ؟",
"حيوانك المُفضل ؟",
...
if text == "علم الدول" or text == "اعلام" then
if Redis:get(TheRhp.."Rhp:Status:Games"..msg.chat_id) then
...
LuaTele.editMessageText(ChatId,Msg_id,help1 or TextHelp, 'md', true, false, reply_markup)
end
...
data = {
{
{text = '⭐ Featured', data = IdUser..'/kkk'}, {text = '🕹 Arcade', data = IdUser..'/kkk1'},
},
{
{text = '⚽ Sport', data = IdUser..'/kkk2'}, {text = '🥊 Action', data = IdUser..'/kkk3'},
},
{
{text = '🌀 Puzzle', data = IdUser..'/kkk4'}, {text = '💥 Quickies', data = IdUser..'/kkk5'},
},
{
{text = '🛀 Relax', data = IdUser..'/kkk6'}, {text = '🏎️ Racing', data = IdUser..'/kkk7'},
},
{
{text = '🤪 Crazy', data = IdUser..'/kkk8'}, {text = 'رجوع', data = IdUser..'/help7'},
},
{
{text = '𝑺𝒐𝒖𝒓𝒄𝒆', url = "https://t.me/IElE3"},
},
...
local TextHelp = [[
⇜ اختر الفئة التي تريد لعبها .
]]
LuaTele.editMessageText(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
elseif Text and Text:match('(%d+)/kkk') then
local UserId = Text:match('(%d+)/kkk')
if tonumber(IdUser) == tonumber(UserId) then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
{text = 'Neon Blaster', url = "https://t.me/gamee?game=NeonBlaster"}, {text = 'Neon Blaster 2', url = "https://t.me/gamee?game=NeonBlast2"},
},
{
