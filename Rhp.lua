...
Redis:del(TheRhp..'Rhp:FilterText'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"⇜ ابشر الغيت منع ("..Filters..")","md",true)  
end
end
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
...
return LuaTele.sendText(msg_chat_id,msg_id,'⇜ ابشر الغيت كل شي')
end
Redis:del(TheRhp..'Rhp:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id)
if text and text:match("^@[%a%d_]+$") then
local UserId_Info = LuaTele.searchPublicChat(text)
...
return LuaTele.sendText(msg_chat_id,msg_id,"⇜ ابشر الغيت كل شي ","md",true)         
end
...
Redis:del(TheRhp.."Rhp:gamebot:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,true)
Redis:del(TheRhp.."Rhp:gamebot:Set:Manager:On"..msg.sender.user_id..":"..msg_chat_id,true)
return LuaTele.sendText(msg_chat_id,msg_id,"⇜ ابشر الغيت كل شي ","md",true)   
end
...
if text and text:match("^(.*)$") then
if Redis:get(TheRhp.."Rhp:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id.."") == "true2" then
if Redis:sismember(TheRhp.."Rhp:List:Manager"..msg.sender.user_id..":"..msg_chat_id)
LuaTele.sendText(msg_chat_id,msg_id,"⇜ مافيه رد كذا","md",true)  
return false
end
end
...
local Text = Text:gsub('{البايو}',Bio)
...
local Texingt = Texingt:gsub('{البايو}',Bio)
...
local Bio = getbio(Message_Reply.sender.user_id)
if UserInfo.username then
UserInfousername = '@'..UserInfo.username..''
else
UserInfousername = 'لا يوجد'
...
if text and text:match('^كشف @(%S+)$') then
local UserName = text:match('^كشف @(%S+)$')
...
local Bio = getbio(UserId_Info.id)
...
if text == 'البايو' or text == 'بايو' and msg.reply_to_message_id ~= 0 then
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
local Bio = getbio(Message_Reply.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,
'\n['..Bio..
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⇜ مدير من قبل ").Reply,"md",true)  
else
...
if not msg.Developers then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n⇜ هذا الامر يخص ( المطور ) بس ',"md",true)
end
...
katu = {"95","399","9","32","100","90","45","119","877","8","55","114","143","144","153","932","211","13","67","515","520","511","509"}
local time = os.time()
Redis:set(TheRhp.."Rhp:Game:Time"..msg.chat_id,time)
name = katu[math.random(#katu)]
...
name = string.gsub(name,"32","10+22")
name = string.gsub(name,"100","12+88")
name = string.gsub(name,"90","30+60")
name = string.gsub(name,"45","5×9")
